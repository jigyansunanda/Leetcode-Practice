<h2><a href="https://leetcode.com/problems/making-file-names-unique">1611. Making File Names Unique</a></h2><h3>Medium</h3><hr><p>Given an array of strings <code>names</code> of size <code>n</code>. You will create <code>n</code> folders in your file system <strong>such that</strong>, at the <code>i<sup>th</sup></code> minute, you will create a folder with the name <code>names[i]</code>.</p>
